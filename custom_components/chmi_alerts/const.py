...
# Format: (code, name)
# Sorted alphabetically by name using Czech collation
CISORP_LOCATIONS = [
    ("4101", "Aš"),
    ("2101", "Benešov"),
    ("2102", "Beroun"),
...
# Create a lookup dictionary for getting location names from codes
CISORP_CODE_TO_NAME = dict(CISORP_LOCATIONS)
